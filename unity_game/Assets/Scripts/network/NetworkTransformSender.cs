...
public class NetworkTransformSender : MonoBehaviour {
	...
	public float sendingPeriod = 0.03f; // We will send transform each 0.1 second. To make transform synchronization smoother consider writing interpolation algorithm instead of making smaller period.
