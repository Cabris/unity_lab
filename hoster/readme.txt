...
after lunch the app, make sure the streaming server is on and started streaming,
then in the app type in the server ip and port, press "connect".
video from server should be display on the device. 
